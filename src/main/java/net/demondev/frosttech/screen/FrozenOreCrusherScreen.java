...
public class FrozenOreCrusherScreen extends AbstractContainerScreen<FrozenOreCrusherMenu> {
    // Define the texture path for the GUI
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(FrostTech.MOD_ID, "textures/gui/frozen_ore_crusher_gui.png");
    ...
    public FrozenOreCrusherScreen(FrozenOreCrusherMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
